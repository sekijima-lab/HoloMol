...
namespace OrbCreationExtensions
{
    public static class StringExtensions
    {
        ...
        public static string RemoveStartCharactersIfPresent(this string str, string startString) {
            if(startString!=null && str.StartsWith(startString)) {
                string newStr = str.Substring(startString.Length, str.Length-startString.Length);
                return newStr;
            }
            return str;
        }
